...
private:
    bool dfs(int v, const std::vector<std::vector<int>>& graph, std::vector<int>& vis, const std::vector<int>& ex)
    {
        if (!ex[v])
        {
            return false;
    ...
    void dfs2(int v, const std::vector<std::vector<int>>& graph, std::vector<int>& vis, std::vector<char>& res, const std::vector<int>& ex)
    {
        if (!ex[v])
        {
            return;
